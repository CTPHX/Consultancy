...
public sealed record SavedSessionHost(
    string Name, string? Status, bool? AllowNewSession, int? Sessions, string? VmName, string? VmResourceGroup,
    string? NicName, string? VnetName, string? SubnetName, string? GalleryName, string? GalleryResourceGroup,
    string? ImageDefinition, string? ImageVersion);
